...
<div class="container mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="books/list.php" class="mt-4 inline-block text-sm text-blue-500 hover:text-blue-700">View All Books <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="borrowers/list.php" class="mt-4 inline-block text-sm text-green-500 hover:text-green-700">View All Borrowers <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="borrowed/list.php" class="mt-4 inline-block text-sm text-purple-500 hover:text-purple-700">View All Borrowed <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="borrowed/list.php?filter=overdue" class="mt-4 inline-block text-sm text-red-500 hover:text-red-700">View Overdue Books <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="border-b border-gray-200 px-6 py-4">
            <h3 class="text-lg font-medium">Recent Borrowed Books</h3>
        </div>
        <div class="p-6">
            ...
            <?php endif; ?>
            <div class="mt-4">
                <a href="borrowed/borrow.php" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors">
